...
//                 {/* <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between bg-white/50 p-10 rounded-lg shadow-lg mt-20"> */}
//                 <div className="relative max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between bg-white/50 backdrop-blur-lg p-10 rounded-2xl shadow-xl mt-20">
//                     <div className="md:w-1/2 text-center md:text-left">
//                         <h1 className="text-4xl font-bold text-gray-900">
//                             Get Your Ticket Online, Easy and Safely
...
//                                 <input type="text" placeholder="From" className="w-1/2 p-3 border rounded-lg" />
//                                 <input type="text" placeholder="To" className="w-1/2 p-3 border rounded-lg" />
//                             </div>

//                             <input type="date" className="w-full p-3 border rounded-lg" />

//                             <Link href="/findtickets">
//                                 <button className="w-full px-4 py-3 bg-[#FF6B6B] text-white font-semibold rounded-lg shadow-md hover:bg-[#E55A5A]">
//                                     Find Tickets
//                                 </button>
//                             </Link>
